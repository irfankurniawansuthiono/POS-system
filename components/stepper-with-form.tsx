...
function PersonalInfoForm({
    ...
    return (
        <form id="stepper-form-personal" onSubmit={form.handleSubmit(onNext)} className="space-y-4">
            <FieldGroup>
                <Controller
                    name="firstName"
                    ...
                    render={({ field, fieldState }) => (
                        <Field data-invalid={fieldState.invalid}>
                            <FieldLabel htmlFor="stepper-form-personal-firstName">First Name</FieldLabel>
                            <Input
                                {...field}
                ...
                <Controller
                    ...
                    render={({ field, fieldState }) => (
                        <Field data-invalid={fieldState.invalid}>
                            <FieldLabel htmlFor="stepper-form-personal-lastName">Last Name</FieldLabel>
                            <Input
                                {...field}
...
function ContactInfoForm({
    ...
    return (
        <form id="stepper-form-contact" onSubmit={form.handleSubmit(onNext)} className="space-y-4">
            <FieldGroup>
                <Controller
                    name="email"
                    control={form.control}
                    render={({ field, fieldState }) => (
                        <Field data-invalid={fieldState.invalid}>
                            <FieldLabel htmlFor="stepper-form-contact-email">Email</FieldLabel>
                            <Input
                                {...field}
                                type="email"
                ...
                <Controller
                    ...
                    render={({ field, fieldState }) => (
                        <Field data-invalid={fieldState.invalid}>
                            <FieldLabel htmlFor="stepper-form-contact-phone">Phone</FieldLabel>
                            <Input
                                {...field}
...
function AddressForm({
    ...
    return (
        <form id="stepper-form-address" onSubmit={form.handleSubmit(onNext)} className="space-y-4">
            <FieldGroup>
                <Controller
                    name="street"
                    control={form.control}
                    render={({ field, fieldState }) => (
                        <Field data-invalid={fieldState.invalid}>
                            <FieldLabel htmlFor="stepper-form-address-street">Street Address</FieldLabel>
                            <Input
                                {...field}
                ...
                <Controller
                    ...
                    render={({ field, fieldState }) => (
                        <Field data-invalid={fieldState.invalid}>
                            <FieldLabel htmlFor="stepper-form-address-city">City</FieldLabel>
                            <Input
                                {...field}
                ...
                <Controller
                    ...
                    render={({ field, fieldState }) => (
                        <Field data-invalid={fieldState.invalid}>
                            <FieldLabel htmlFor="stepper-form-address-zipCode">ZIP Code</FieldLabel>
                            <Input
                                {...field}
