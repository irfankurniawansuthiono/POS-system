...
export function SingleFileUpload({ value, onChange, onRemove, disabled, className }: SingleFileUploadProps) {
    ...
    if (value) {
        return (
            <div className={cn("relative flex items-center p-4 border rounded-lg bg-muted/30 gap-4", className)}>
            ...
            {isUploading ? (
                ...
                <>
                    ...
                    <div className="text-center space-y-1">
                        <p className="text-sm font-medium">{isDragActive ? "Drop PDF here" : "Upload PDF"}</p>
