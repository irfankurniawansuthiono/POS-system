...
export default function SortBySuppliers({
  // desc/asc Button
  sortBy,
  setSortBy,
  sortDirection,
  ...
  sortBy: "name" | "email" | "createdAt" | "updatedAt" | "companyName" | "contactPerson" | "city" | "address" | "phone" ;
      ...
      <Select onValueChange={setSortBy} defaultValue={sortBy}>
        ...
        <SelectContent>
          <SelectGroup>
            ...
            <SelectItem value="companyName">Email</SelectItem>
