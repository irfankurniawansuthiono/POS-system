...
export default function EditBrand({ name, logoUrl, id }: { name: string; logoUrl: string | null; id: string }) {
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        <DialogHeader>
                            ...
                            <DialogDescription>Edit the {name}&apos;s brand name and logo</DialogDescription>
                        </DialogHeader>
                        ...
                        <DialogFooter>
                            ...
                            <ButtonWithIcon
                                type="submit"
                                startIcon={editBrandMutation.isPending ? <Spinner /> : <Pencil />}
                                className={`${
